    ...
    return(
        <div className="input-comment-wrapper h-1/6 w-full bg-gray-900">
            <form onSubmit={handleCommentSubmit}className='flex w-full h-full justify-center items-center'action="">
                <div className="relative w-80 h-12 bg-white rounded-lg ">
                <div className="w-full h-full">
                <input onChange={handleChangeComment} value={commentText} className="w-60 h-full rounded-lg p-3 text-sm bg-transparent border-none focus:outline-none" name='comment' placeholder="Insert your comment here..." type="text" />
                </div>
